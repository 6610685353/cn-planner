...
class AppColors {
  static const Color primaryYellow = Color(0xFFE5AD00);
  static const Color accentYellow = Color(0xFFFFC207);
  static const Color darkYellow = Color(0xFF9D8A4F);
  ...
  static const Color errorRed = Color(0xFFAE0000);
