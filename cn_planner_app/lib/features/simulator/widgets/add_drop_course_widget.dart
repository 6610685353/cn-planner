...
//     final hasActions = _pendingActions.isNotEmpty;
...
//                       Text(
//                         'Simulated changes (${_pendingActions.length})',
...
//                                 : const Color(0xFFEF4444), // Red minus
//                           ),
//                           const SizedBox(width: 8),
//                           Expanded(
//                             child: Text(
//                               '${a.isAdd ? "Add" : "Drop"}: ${a.course.code} – ${a.course.name}',
//                               style: const TextStyle(
//                                 fontSize: 13,
...
//     setState(() {
//       _codeError = code.isEmpty ? 'กรุณากรอกรหัสวิชา' : null;
//     });
...
//     // Appending category to the name so it's visible, adjust if CourseModel has a category field
//     final baseName = _nameCtrl.text.trim().isEmpty
//         ? code
//         : _nameCtrl.text.trim();
//     final finalName = '$baseName [$_selectedCategory]';
...
//     final allAvailable = CurriculumData.getAllCourses();
